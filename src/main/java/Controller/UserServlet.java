...
//        //retriving username
//        if(action.equalsIgnoreCase("cvusername")){
//            int id = Integer.parseInt(request.getParameter("id"));
//            CustomerService cs = new CustomerService();
//            UserStudent st = cs.getUsername(id);
//            request.setAttribute("user" , st);
//            request.getRequestDispatcher("UserPannel/dashboard.jsp").forward(request,response);
//        }
...
//        //EditUsername
//        if (action.equalsIgnoreCase("Editingusername")){
//            UserStudent student = new UserStudent();
//            HttpSession session = request.getSession();
//            int id = (Integer) session.getAttribute("uid");
//            student.setUserName(HashPassword.hashPassword(request.getParameter("username")));
//            new CustomerService().Editname(student, id);
//            RequestDispatcher rd = request.getRequestDispatcher("userlogin.jsp");
//            try {
//                rd.forward(request, response);
//            } catch (ServletException e) {
//                throw new RuntimeException(e);
//            }
//            System.out.println(" Editing username is"+request.getParameter("username"));
//
//        }
        //logout
